...
<table width="90%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td valign="bottom" width="75%" align="right">
        <a href="homeTalk.action">Home</a>&nbsp;<a href="storageTalk.action">Profile</a>&nbsp;<a href="">Find People</a>&nbsp;<a href="settingsTalk.action">Settings</a>&nbsp;<a href="">Help</a>&nbsp;<%if(guest!="guest"){%><a href="exitTalk.action">Sign out</a><%}else{%><a href="<%=path%>/login.jsp">Sign in</a><%}%>
    </td>
  </tr>
</table>
