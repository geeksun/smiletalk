...
<html>
	...
	<body>
		<%
		 ...
		 <pre> <%=guest%>£¬ »¶Ó­ÄúÊ¹ÓÃ iTalk									<a href="">Home</a>&nbsp;<a href="">Profile</a>&nbsp;<a href="">Find People</a>&nbsp;<a href="">Settings</a>&nbsp;<a href="">Help</a>&nbsp;<a href="">Sign out</a>&nbsp;<a href="<%=path%>/login.jsp">µÇÂ¼iTalk</a></pre>
